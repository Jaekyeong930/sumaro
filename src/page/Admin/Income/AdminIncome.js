			...
			<div className='period_income'>
				<div className='setPeriod'>
					<div className='income_form'>
						...
						<span className='date_standard'>期間</span>
						<input
				...
				<div className='income'>
					総収入 <span className='allOfIncome'>{setFeeFormat(total)}</span>円 &nbsp;
...
{/* 				
			...
			<div className='chart'>
				{feeData.length > 0 ? (
					...
					<div className='no_data'>データがありません</div>
				)}
			</div>
			{/* 요금 설정 */}
			<Modal>
				<div className='setFee'>
					...
					円で変更します。 &nbsp;&nbsp;&nbsp;
					<br/>
					<button id='set_fee_btn' onClick={handleSetFee}>設定</button>
				</div>
			</Modal>
		</>
	);
