...
const CurrentPList = () => {
	...
	const getNowFee = (entryTime, fee) => {
		...
		var elapsedHours = Math.floor(Interval / (1000 * 60 * 10 ) + 1); // 올림 (10분 단위로 계산)
		var userFee = Math.ceil( elapsedHours * (fee) );
